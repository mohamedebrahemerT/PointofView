                            ...
                            <form method="post" action="{{url('/')}}/register-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="National_ID" class="form-control"
                                           placeholder="رقم الهوية الوطنية أو اإلقامة" value="" required=""/>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="name_ar" class="form-control"
                                           ...
                                           value="{{ Auth::user()->first_name  ?? '' }}    {{ Auth::user()->last_name  ?? ' الاسم الرباعي باللغة العربية   حسب االثبات الرسمي  ' }}"
                                ...
                                <div class="form-group">
                                    <input type="text" name="Qualification" class="form-control"
                                           placeholder="المؤهل العلمى " value="" required=""/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="org_num" class="form-control"
                                           placeholder="رقم التسجيل بالهيئة للدورات الصحية ( إن وجد ) " value=""
                                           required=""/>
                                </div>
                                <div class="form-group">
                                    <div class="container">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $(".btn-submit").click(function (e) {
                    ...
                    $.ajax({
                        url: "{{url('/')}}/register-form",
                        type: 'POST',
                        data: {
                            _token: _token, course_id: course_id, National_ID: National_ID,
