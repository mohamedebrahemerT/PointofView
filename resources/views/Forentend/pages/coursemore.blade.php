            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="course-essentials bg-white">
                        ...
                        @php
               $UserCoursescount=App\Models\UserCourses::
               where('user_id',auth()->user()->id)->
               where('course_id',$Course->id)->
               where('certificate_status','=',null)->
...
<a href="{{url('/')}}/RequestCertificates/{{$Course->id}}/{{auth()->user()->id}}" class="register">طلب الشهادة </a>
