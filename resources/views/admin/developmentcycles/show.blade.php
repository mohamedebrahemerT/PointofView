...
@section('content')
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="portlet blue-hoki box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i> {{trans('trans.developmentcycle')}}
 </div>
                                <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value">{{$developmentcycle->title}}</div>
                                    </div>
                                    <div class="row static-info">
                                        <div class="col-md-5 name">  {{trans('trans.desc')}}</div>
                                        <div class="col-md-7 value"> 
{!!$developmentcycle->desc!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value"> 
                                              ...
                                              <img src="{{url('/')}}/{{$developmentcycle->img}}"  style="width:100px;height:100px">
