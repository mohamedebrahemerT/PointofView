            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> {{trans('trans.Certificate')}}</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group">
                                    <a href="{{url('/')}}/Certificate/create" id="sample_editable_1_new"
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a href="{{url('/')}}/Certificate/{{$Certificate->id}}">
                                                    <i class="icon-tag"></i>
                                            ...
                                            <li>
                                                <a href="{{url('/')}}/Certificate/{{$Certificate->id}}/destroy">
                                                    <i class="icon-tag"></i>
                                                    {{trans('trans.delete')}}
                                                </a>
                                            </li>
