...
@push('js')
        ...
        language: 'en',
                  ...
                  <form role="form" action="{{url('/')}}/carreer" method="POST" enctype="multipart/form-data">
                    @csrf
 ...
 <div class="form-group">
          ...
          <div class="form-group">
                ...
                <div class="form-group">
                               <label class="control-label">{{trans('trans.img')}}- Width:700 px and Height:700 px</label>
