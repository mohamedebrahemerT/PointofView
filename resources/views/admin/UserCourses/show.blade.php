...
@section('content')
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="{{url('/')}}/UserCoursess">{{trans('trans.UserCoursess')}}</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="portlet blue-hoki box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i>  طلب المتدرب 
 </div>
                                <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value">
                                             @if($UserCourses->user_id != null)
       {{$UserCourses->user->first_name}}    {{$UserCourses->user->last_name}}
      @endif
                                        </div>
                                    </div>
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value"> 
  {{$UserCourses->course->title}}
                                        </div>
                                    </div>
                                    <div class="row static-info">
                                        <div class="col-md-5 name"> {{trans('trans.department')}} </div>
                                        <div class="col-md-7 value"> 
                                             {{$UserCourses->course->department->title}}
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row static-info">
                                        ...
                                        <div class="col-md-7 value"> 
                                              ...
                                              <img src="{{url('/')}}/{{$UserCourses->course->img}}"  style="width:100px;height:100px">
